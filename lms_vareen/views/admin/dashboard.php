...
<div class="dashboard-wrapper">
    <?php $admin_active='dashboard'; include __DIR__.'/_sidebar.php'; ?>
        ...
        <div class="kpi-grid">
            <div class="kpi-card"><div class="kpi-icon" style="background:#e8f4fd"><i class="fas fa-user-graduate" style="color:#4facfe"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalStudents; ?>"><?php echo $totalStudents; ?></span><span class="kpi-label">Students <small style="color:#28a745">+<?php echo $studentsThisWeek; ?></small></span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#fdecea"><i class="fas fa-chalkboard-teacher" style="color:#f5576c"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalTeachers; ?>"><?php echo $totalTeachers; ?></span><span class="kpi-label">Teachers</span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#e9f9ef"><i class="fas fa-book" style="color:#28a745"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $publishedCourses; ?>"><?php echo $publishedCourses; ?></span><span class="kpi-label">Active Courses</span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#fff7e6"><i class="fas fa-user-plus" style="color:#b9770e"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalEnrollments; ?>"><?php echo $totalEnrollments; ?></span><span class="kpi-label">Enrollments <small style="color:#28a745">+<?php echo $enrollmentsThisWeek; ?></small></span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#f3e8fd"><i class="fas fa-naira-sign" style="color:#764ba2"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalRevenue; ?>" data-currency="1">₦<?php echo number_format($totalRevenue, 0); ?></span><span class="kpi-label">Revenue <small style="color:#28a745">+₦<?php echo number_format($revenueThisWeek, 0); ?></small></span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#e8f4fd"><i class="fas fa-certificate" style="color:#4facfe"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalCertificates; ?>"><?php echo $totalCertificates; ?></span><span class="kpi-label">Certificates</span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#e9f9ef"><i class="fas fa-comments" style="color:#28a745"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $totalCommunityPosts; ?>"><?php echo $totalCommunityPosts; ?></span><span class="kpi-label">Community Posts</span></div></div>
            <div class="kpi-card"><div class="kpi-icon" style="background:#fdecea"><i class="fas fa-video" style="color:#f5576c"></i></div><div class="kpi-info"><span class="kpi-count" data-target="<?php echo $liveClassesToday; ?>"><?php echo $liveClassesToday; ?></span><span class="kpi-label">Live Classes Today</span></div></div>
        </div>
